...
def sampler_parser(passed_arguments):
    ...
    statistic_list = ['windowed-weir-fst', 'TajimaD', 'windowed-pi']
    ...
    sampler_parser.add_argument('--sample-size', help="Total sample size. If using the uniform sampling scheme, this number must be divisible by the bins", type = int, default = 10)
...
def assign_statistic_column (sample_headers, statistic):
    statistic_converter = {'windowed-weir-fst':'MEAN_FST', 'TajimaD':'TajimaD', 'windowed-pi':'PI'}
