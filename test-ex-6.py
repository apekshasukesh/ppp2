...
#pipe1(".recode.bcf",".windowed.weir.fst","test1")
...
class Test_ruffus(unittest.TestCase):
    ...
    def test_simpler (self):
        pipe1(".recode.bcf",".windowed.weir.fst","test1")
        #pipe2(".recode.bcf",".windowed.weir.fst","test2")
        #pipe2()
        pipeline_run(pipeline= "main")

    def test_simpler1 (self):
        #pipe1(".recode.bcf",".windowed.weir.fst","test1")
        pipe2(".recode.bcf",".windowed.weir.fst","test2")
        #pipe2()
        pipeline_run(pipeline= "main")
